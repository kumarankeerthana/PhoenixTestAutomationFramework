...
public class CreateJobPayload {
	...
	public String toString() {
		return "CreateJobPayload [mst_service_location_id=" + mst_service_location_id + ", mst_platform_id="
				...
				+ ", cutsomer=" + customer + ", customer_address=" + customer_address + ", customer_product="
	...
	public CreateJobPayload(int mst_service_location_id, int mst_platform_id, int mst_warrenty_status_id,
			int mst_oem_id, Customer cutsomer, CustomerAddress customer_address, CustomerProduct customer_product,
			Problems[] problems) {
		super();
	...
	public void setCustomer(Customer cutsomer) {
		this.customer = cutsomer;
	}
