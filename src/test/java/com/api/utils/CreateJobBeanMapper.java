...
public class CreateJobBeanMapper {
	/*
	 * Thos class will take bean as input and create payload for create job api
	 * request
	 */

	private CreateJobBeanMapper() {
		// static aka utitlity classes have private constructor
	}
	...
	public static CreateJobPayload mapper(CreateJobBean bean) {
		...
		CustomerAddress address = new CustomerAddress(bean.getCustomer_address__flat_number(),
		...
		CreateJobPayload payload = new CreateJobPayload(mstServiceLocationId, mstPlatformId, mstWarrantyStatusId,
				mstOemId, customer, address, product, problemList);
